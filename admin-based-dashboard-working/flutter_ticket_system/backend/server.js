...
const jwt = require('jsonwebtoken'); // Importar la librería para generar el JWT
...
const JWT_SECRET = 'tu_clave_secreta'; // Cambia esto por una clave segura
        ...
        (err, userResults) => {
            ...
            db.query(
                ...
                (err, roleResults) => {
                    ...
                    // Mapeo de roles
                    const roles = { 1: 'admin', 2: 'user' }; // Mapa de roles
