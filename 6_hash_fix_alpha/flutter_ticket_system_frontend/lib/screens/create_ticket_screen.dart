...
class _CreateTicketScreenState extends State<CreateTicketScreen> {
  ...
  Future<bool> _isAuthorized() async {
    ...
    return tokenExists && permission != '1'; // Ensure the role is NOT "1" (admin)
  }
  ...
  Future<void> _submitTicket() async {
    if (_formKey.currentState!.validate()) {
      ...
      final uniqueId = prefs.getInt('unique'); // Assuming 'unique' represents user_id

      if (token == null || uniqueId == null) {
        // Handle case where token or user_id is missing
      ...
      try {
        ...
        final response = await http.post(
          Uri.parse('http://localhost:3000/tickets'), // Ensure this is the correct backend URL
          headers: {
