    ...
    try {
        ...
        return res.json({
            ...
            access: {
                ...
                unique: auth[process.env.FIELD_USER_AUTH],
...
app.get('/my-requests', async (req, res) => {
    try {
        const authId = req.query.user_id; // Get user_id from query parameter
...
app.post('/assign-ticket', async (req, res) => {
    ...
    try {
      // Assign the ticket
      const result = await dbManager.assignTicket(ticketId, userId);
